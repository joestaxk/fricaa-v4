...
export const HeroSection = () => {
    ...
    return (
        <div className='gsap-scale h-screen relative flex justify-center  overflow-hidden w-full after:content after:h-full after:absolute after:inset-0 after:z-[5] after:bg-gradient-to-t after:from-black after:to-[30%] after:to-transparent after:block '>
